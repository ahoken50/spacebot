...
const workspace = await mkdtemp(path.join(tmpdir(), 'oasis-failure-remediator-'));
const apiPort = 39171;
...
const task = {
  ...
  status: 'failed',
  owner_agent_id: 'oasis-finances',
  assigned_agent_id: 'oasis-finances',
  revision: 1,
};
const attempt = {
  id: 'attempt-42-1',
...
const child = spawn(process.execPath, ['server.js'], {
  ...
  env: {
    ...
    OASIS_FAILURE_REMEDIATOR_TOKEN: token,
    OASIS_FAILURE_REMEDIATOR_INTERVAL_SECONDS: '3600',
  },
