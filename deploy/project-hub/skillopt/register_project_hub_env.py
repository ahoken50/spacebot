#!/usr/bin/env python3
"""Register the Project Hub SkillOpt environment in the pinned upstream source tree."""
...
SNIPPET = """    try:
        from skillopt.envs.project.adapter import ProjectHubSkillAdapter
        _ENV_REGISTRY["project"] = ProjectHubSkillAdapter
    except ImportError:
        pass
\n"""
...
def patch(path: Path) -> None:
    ...
    if 'skillopt.envs.project.adapter' in text:
        return
