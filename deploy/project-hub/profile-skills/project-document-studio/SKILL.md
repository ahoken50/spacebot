---
name: project-document-studio
description: Production professionnelle de documents Project Hub en DOCX et PDF : brief, rédaction structurée, rendu local, aperçu visuel et contrôle qualité. Utiliser pour tout rapport, note, PV, tableau de synthèse ou livrable destiné à une diffusion.
tags: [project, document, docx, pdf, qualité, rendu]
related_skills: [project-reporting, project-finance-control, project-analysis]
---

# Atelier documentaire Project Hub
...
4. Appeler `render_markdown_document` pour créer le DOCX et/ou le PDF avec la charte Project Hub. Le rendu est réalisé localement par Pandoc et LibreOffice; le document source n’est pas transmis à un moteur de rendu externe.
