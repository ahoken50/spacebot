#!/usr/bin/env python3
"""Créer un squelette de script Python Project Hub dans le workspace partagé."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--agent", required=True, help="ID de l’agent Project Hub créateur.")
    ...
    parser.add_argument("--workspace", default="/data/shared-workspace", help="Racine du workspace Project Hub.")
...
def within_workspace(value: Path) -> Path:
    ...
    if WORKSPACE != resolved and WORKSPACE not in resolved.parents:
        raise ValueError("Le chemin doit rester dans le workspace Project Hub.")
    return resolved
...
- Entrée : chemin explicite sous le workspace Project Hub.
- Sortie : chemin explicite sous le workspace Project Hub.
